...
const VoiceGeneratorUI: React.FC = () => {
   ...
   const backendUrl = process.env.NEXT_PUBLIC_BACKEND_URL;
    ...
    const handleDownload = async () => {
        ...
        // For the test audio file, create a download link
                ...
                <div className="relative z-10 bg-white w-full h-[450px] rounded-3xl shadow-md flex flex-col justify-between mb-5">
                    ...
                    <div className="p-6 mb-30">
                        <textarea
                            ...
                            className="w-full h-24 text-black leading-relaxed resize-none border-none outline-none bg-transparent"
                        ...
                        <div className="flex items-center justify-between px-8 ">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3">
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="h-8 sm:h-9 md:h-10 bg-black text-white rounded-full flex items-center 
               gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 
              transition-colors duration-200 
               text-xs sm:text-sm md:text-base font-medium 
               disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#6E6E6E]"
                                >
                                    {(
                                        <>
                                ...
                                <button
                                    ...
                                    className="h-8 sm:h-9 md:h-10 w-8 sm:w-9 md:w-10 border border-gray-200 text-gray-700 rounded-full 
